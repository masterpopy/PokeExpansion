...
#define STAT_CRITIC  8 // Only in battles.
...
//nick name只在存入pc的时候存入存档。从pc中拿去的时候会读取name到Pokemon中
...
#define MON_DATA_MINTNATURE        89
#define MON_DATA_SPECIES3             90
#define MON_DATA_NAME_BIT             91
#define MON_DATA_FIXED_IV             92
#define MON_DATA_HT_IV             93
#define MON_DATA_MAX_SOUP             94
...
#define OT_ID_RANDOM_NO_SHINY 2 //invalid
...
#define FLAG_THAW_USER              0x1000000 //
#define FLAG_ALWAYS_CRIT             (1<<25) //
...
#define EVO_LEVEL_NATURE 0x001F
#define EVO_NIGHT_ITEM 0x0020
#define EVO_MAP_LEVEL 0x0021 //不同道路等级进化
#define EVO_LEVEL_SNOW 0x0022 //雪天等级进化
#define EVO_LEVEL_SANDSTORM 0x0023 //沙暴等级进化
#define EVO_LEVEL_SUN 0x0024 //晴天等级进化
#define EVO_MAP_LEVEL_DAY 0x0025 //不同道路白天等级进化
#define EVO_MAP_LEVEL_NIGHT 0x0026 //不同道路夜晚等级进化
#define EVO_ITEM_TIME 0x0027 //携带道具时间进化
#define EVO_LEVEL_SNOW_DAY 0x0028 //下雪白天进化
#define EVO_LEVEL_SNOW_NIGHT 0x0029 //下雪夜晚进化
#define EVO_LEVEL_SNOW_DUSK 0x0030 //下雪黄昏进化
#define EVO_MAP_LEVEL_DUSK 0x0031 //不同道路黄昏等级进化
#define EVO_MEGA_EVOLUTION     0xf0 // Not an actual evolution, used to temporarily mega evolve in battle.
#define EVO_PRIMAL_EVOLUTION   0xf1 //原始回归
#define EVO_FEVERT_EVOLUTION   0xf2 //fevert wish
#define EVO_BATTLE_SWITCH_IN   0xf3 //战斗内进场
#define EVO_BATTLE_USE_MOVE    0xf4 //战斗内使用某个技能
#define EVO_BATTLE_HP          0xf4 //战斗内血量
#define EVO_FIELD_ITEM         0xf5 //仅仅携带道具
#define EVO_DYNAMAX            0xf6 //极巨化
#define EVO_CANNOT_DYNAMAX     0xf7 //不允许极巨化标识
#define EVO_REVERT_MEGA        0xf8 //mega回退
#define EVO_REVERT_SWITCH_IN   0xf9 //剑盾回退

#define EVOS_PER_MON 3
...
#define FORM_ITEM_HOLD_MOVE     7
#define FORM_BATTLE_ABITITY     8
